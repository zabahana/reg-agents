...
> Generated by `scripts/generate_model_development_doc.py` on 2026-07-22 19:40 UTC.
...
|---|---|---|---|
| logistic_regression | TF-IDF 30k, 1-2 gram, sublinear, min_df=2 | L2, C=4.0, max_iter=2000, class_weight='balanced' | 0.05 |
| xgboost | same TF-IDF features | 300 trees, depth 6, lr 0.1, hist, aucpr, scale_pos_weight=0.0 | 4.94 |
| lightgbm | same TF-IDF features | 400 trees, 63 leaves, lr 0.05, class_weight='balanced' | 7.02 |
| bert_finetuned | raw text → WordPiece subwords | distilbert-base-uncased, max_len=256, batch 16, AdamW lr 3e-5, 2 epochs, class-weighted cross-entropy | 98.1 |
...
|---|---|---|---|---|---|---|---|---|
| logistic_regression | 0.204 | 0.788 | 0.206 | 0.7965 | 0.1538 | 0.584 | 0.0346 | 0.05 |
| xgboost | 0.1579 | 0.844 | 0.1938 | 0.7355 | 0.1702 | 0.613 | 0.0395 | 4.94 |
| lightgbm | 0.3011 | 0.883 | 0.2467 | 0.8459 | 0.1429 | 0.5385 | 0.0321 | 7.02 |
| bert_finetuned | 0.1469 | 0.950 | 0.1517 | 0.7996 | 0.175 | 0.6875 | 0.0433 | 98.1 |
