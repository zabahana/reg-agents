...
> Generated by `scripts/generate_complaint_data_profile.py` on 2026-07-29 20:43 UTC · Source: **CFPB Consumer Complaint Database** (public, PII-masked) · every number recomputed from `data/complaints/cfpb_complaints.csv`.
...
| 4 · Near dedup | First-200-chars fingerprint + TF-IDF-cosine fuzzy pass (≥ 0.9) over the whole pool (Curator: MinHash / FuzzyDuplicates) | removes template complaints that would leak across splits |
| 5 · PII check | CFPB pre-masks PII as 'XXXX'; verified present, no raw PII added | 80% of narratives carry masking tokens |
| 6 · Balanced sampling | Per product-issue cap to fight credit-reporting skew | PER_ISSUE_CAP=350 · max observed 764 |
...
|---|---|---|---|
| REG_E_UNAUTHORIZED | Reg E / EFTA — Unauthorized Transfers | 1,122 | 28.1% |
| BSA_AML | BSA/AML — Account Freezes & Closures | 901 | 22.5% |
| NON_REGULATORY | Non-Regulatory — General Service | 500 | 12.5% |
| TISA_REG_DD | TISA / Reg DD — Deposit Account Disclosures | 345 | 8.6% |
| REG_CC_FUNDS | Reg CC — Funds Availability | 312 | 7.8% |
| FCRA_ACCURACY | FCRA — Accuracy of Reported Information | 191 | 4.8% |
| GLBA_PRIVACY | GLBA / Privacy — Information Sharing & Safeguards | 121 | 3.0% |
| ECOA_DISCRIMINATION | ECOA / Reg B — Credit Discrimination | 119 | 3.0% |
| FCRA_PERMISSIBLE_PURPOSE | FCRA — Permissible Purpose / Improper Use | 114 | 2.9% |
| FCRA_INVESTIGATION | FCRA — Reinvestigation of Disputes | 72 | 1.8% |
| SALES_PRACTICES | Sales Practices — Unauthorized Accounts/Products | 61 | 1.5% |
| FDCPA_DEBT_VALIDATION | FDCPA — Debt Validation / Not Owed | 42 | 1.1% |
| ECOA_ADVERSE_ACTION | ECOA / Reg B — Adverse Action Notices | 25 | 0.6% |
| UDAAP | UDAAP — Unfair, Deceptive, or Abusive Acts | 22 | 0.5% |
| RESPA_SERVICING | RESPA — Mortgage Servicing & Escrow | 11 | 0.3% |
| LOAN_SERVICING | Loan Servicing (Auto/Student/Personal) — UDAAP & Servicing Rules | 10 | 0.2% |
| FDCPA_THREATS | FDCPA — False Statements or Threats | 8 | 0.2% |
| REG_Z_DISCLOSURE | Reg Z / TILA — Fees, Interest & Disclosures | 8 | 0.2% |
| TILA_ORIGINATION | TILA — Credit Origination & Underwriting Disclosures | 5 | 0.1% |
| REG_Z_BILLING | Reg Z / FCBA — Billing Error Disputes | 4 | 0.1% |
| FDCPA_COMMUNICATION | FDCPA — Communication Tactics | 3 | 0.1% |
| REG_E_ERROR_RESOLUTION | Reg E / EFTA — Error Resolution | 2 | 0.1% |
| RESPA_LOSS_MITIGATION | RESPA — Loss Mitigation & Foreclosure | 1 | 0.0% |
| SCRA_MLA | SCRA / MLA — Servicemember Protections | 1 | 0.0% |
...
| mean | 980 |
| std | 557 |
| min / p25 / median / p75 / max | 120 / 493 / 870 / 1513 / 1800 |
